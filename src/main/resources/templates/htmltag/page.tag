  ...
  <ul class="pagination">
	@if(query.totalPage<=10){//小于10页直接全部输出
		@for(var i in range(1,query.totalPage+1)){
			<li class="${i==query.pageNumber?'active'}"><a href="${ctxPath}${pageUrl}${i}.html">${i}</a></li>
		@}
	@}else{
		...
		@if(start>1){
			<li><a href="${ctxPath}${pageUrl}1.html">首页</a></li>
		...
		@if(end<query.totalPage){
			<li class="disabled"><a href="javascript:;">···</a></li>
			<li><a href="${ctxPath}${pageUrl}${query.totalPage}.html">尾页</a></li>
		@}
	@}
  </ul>
</nav>
